...
| `/profile` | `/api/profile` | — | Career-profile editor (F1 skeleton + F2 skills table + F3 identity/questionnaire + F4 roles/extras/notes — all editable; leftovers still read-only, upload/parse is F5); mock-first behind `PROFILE_MOCK_FALLBACK_ENABLED`, see `docs/RESUME_PROFILE_STORE.md` |
