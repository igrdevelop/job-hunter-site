...
| `/files` | candidate/ | Browse + upload personal candidate assets (YAML, base CV, notes) |
| `/generated` | Applications/ | Browse generated CVs/cover letters by date/company |
| `/templates` | candidate/templates/ | Upload/browse resume & cover-letter templates |
...
| 2026-08-04 | grok | `/files` now browses/uploads `candidate/`; Applications date/company tree moved to `/generated` (folder cell links updated). Companion API branch `feature/candidate-files-and-generated`. |
