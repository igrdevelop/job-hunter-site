...
| `/profile` | `/api/profile` | — | Career-profile editor (F1: read-only skeleton — identity, questionnaire, skills table, roles, leftovers, empty state); mock-first behind `PROFILE_MOCK_FALLBACK_ENABLED`, see `docs/RESUME_PROFILE_STORE.md` |
