...
| `/profile` | `/api/profile`, `/api/profile/uploads`, `/api/profile/jobs/:id` | — | Career-profile editor (F1–F4 fully editable + F5 upload → parse → merge confirmation screen; F6 revisions not started); mock-first behind `PROFILE_MOCK_FALLBACK_ENABLED`, see `docs/RESUME_PROFILE_STORE.md` |
